      ...
      <div className="container mx-auto p-6 max-w-4xl bg-white shadow-lg rounded-lg my-8">
        ...
        <section className="mb-8">
          <ol className="list-decimal list-inside text-lg text-gray-700 ml-4 space-y-3">
            <li>
              Verifique o ícone de atualização do Windows na janela, se estiver com o símbolo conforme imagem abaixo clique com o botão direito em cima, 
            </li>
            ...
            <li>
              Quando estiver instalando vai aparecer igual pagina abaixo, mostrará a porcentagem da instalação,
            </li>
            <div className='flex justify-center'>
              <Image
            ...
            <li>
              Quando finalizar de instalar pode ser que apareça solicitação de “Reiniciar”, finalize e salve todos os documentos e programas que você estava utilizando, após fazer esse passo clique no botão para reiniciar, aguarde o Windows reiniciar e pronto seu computador esta atualizado.
            </li>
          </ol>
        </section>
      </div>
