  ...
  return (
    <Layout>
        ...
        <div className="container mx-auto p-6 max-w-4xl bg-white shadow-lg rounded-lg my-8">
            ...
            <p className='pb-5'>
                Encontramos aqui essa solução para atualizar na nova versão dos sistemas Frigo, Desossa, Matanca e Pesagem, fica registrado e listado abaixo.
            </p>

            <section className="mb-8">
            <ol className="list-decimal list-inside text-lg text-gray-700 ml-4 space-y-3">
                <li>
                    Abra o CMD e digite as teclas F: depois aperte a tecla Enter, após isso digite a palavra Atualiza e aperte a tecla Enter:
                </li>
                ...
                <li>
                    Logo após vai abrir uma tela igual abaixo, siga as instruções, e aperte a tecla Enter.
                </li>
                <div className='flex justify-center'>
                <Image
                ...
                <li>
                    Após esse passo, ele vai carregar todos os arquivos de atualização fechar o terminal CMD e abrir os sistemas.
                </li>
            </ol>
            </section>
        </div>
