    ...
    <Layout>
        ...
        <div className="container mx-auto p-6 max-w-4xl bg-white shadow-lg rounded-lg my-8">
            ...
            <ol className="list-decimal list-inside text-lg text-gray-700 ml-4 space-y-3">
                ...
                <li>
                    Quando iniciar, clicar com o botão esquerdo na janela e ir para “Propriedades”:
                </li>
                <div className='flex justify-center'>
                <Image
                ...
                <li>
                    Na aba “Fonte” Ajustar o tamanho para 24 e a fonte para Lucida Console
                </li>
                <div className='flex justify-center'>
                <Image
                ...
                <li>
                    Na aba “Layout” ajustar Largura em 80 e Altura em 25 e marcar as caixas de seleção assim como na imagem abaixo. 
                </li>
                <div className='flex justify-center'>
                <Image
                ...
                />
                 ...
                 <li>
                    Clicar em ok e abrir novamente o terminal.
                </li>
            </ol>
            </section>
            ...
            <section>
                ...
                <p className="text-lg leading-relaxed bg-yellow-50 border-l-4 border-yellow-500 text-yellow-800 p-4 rounded-md">
                    Se a janela não estiver no modo de visualização igual ao desse manual, vá até a seção 
                    <Link  href={'/windows-page/cmd-page/atualizar'}>
                      <strong className='text-blue-400'> [Atualização do Sistema TANURESOFT]</strong>
                    </Link>
                </p>
                <p className="text-lg mt-5 leading-relaxed bg-yellow-50 border-l-4 border-yellow-500 text-yellow-800 p-4 rounded-md">
                    Importante lembrar de só fixar o CMD na barra de tarefas após concluir esses passos.
                </p>
            </section>
        </div>
    </Layout>
