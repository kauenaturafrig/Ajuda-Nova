    ...
    <Layout>
      <div className='max-w-[90%] mx-auto mt-9 pt-2'>
        ...
        <section className='max-w-[90%] mx-auto dark:text-white'>
          <Link href={'/windows-page/cmd-page'} className="flex items-center border-l-4 border-green-700 mb-5 space-x-2 hover:text-white hover:bg-green-700 p-2 rounded text-2xl">
            <span>Como configurar o CMD - (Prompt de comando)</span>
          </Link>
          <Link href={'/windows-page/update'} className="flex items-center border-l-4 border-green-700 mb-5 space-x-2 hover:text-white hover:bg-green-700 p-2 rounded text-2xl">
