...
import ramais from "../data/ramais/ramais-pirapozinho.json"; // importe os dados
...
export default function RamaisPirapozinho() {
    ...
    <Layout>
      ...
      <div className="container mx-auto p-6 bg-white shadow-lg rounded-lg my-8">
        ...
        <div className="flex items-start gap-6">
          ...
          <div className="max-h-[1100px] max-w-lg overflow-y-auto flex-1">
          ...
          <div className="flex-1">
            <Image
              src={"/assets/images/ramais/pirapozinho.png"}
              alt="Ramais Pirapozinho"
              width={0}
              height={0}
              sizes="100vw"
