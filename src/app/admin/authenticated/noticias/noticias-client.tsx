...
export default function NoticiasClient({
  ...
  // Drag & Drop handlers (igual recados)
        ...
        <div className="space-y-4">
          {noticias.length === 0 ? (
            ...
            noticias.map((noticia) => (
              <div key={noticia.id} className="p-6 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950/50 rounded-2xl border">
                <div className="flex justify-between items-start mb-4">
                  ...
                  <div className="flex gap-2">
                    <Button onClick={() => handleEdit(noticia)} size="sm" className="bg-green-600 text-white">
                      Editar
                    </Button>
                    <Button onClick={() => handleDelete(noticia.id)} size="sm" variant="destructive" className="bg-red-600 text-white">
                      Excluir
                    </Button>
                  </div>
                </div>
