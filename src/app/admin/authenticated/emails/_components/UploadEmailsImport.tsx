...
import { Upload, X, FileText, Loader2, CheckCircle, Mail } from "lucide-react";
...
export default function UploadEmailsImport({ onImportSuccess }: Props) {
  ...
  const handleUpload = async () => {
    ...
    try {
      showToast({
        title: "⏳ Importando...",
        message: "Analisando e importando emails...",
      });
  ...
  return (
    <>
      ...
      <Button 
        ...
        className="bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white shadow-lg hover:shadow-xl transition-all duration-300 px-6"
      >
          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl w-full max-w-md max-h-[90vh] overflow-hidden shadow-2xl border border-gray-200 dark:border-gray-800">
            ...
            <div className="p-6 pb-4 border-b border-gray-200 dark:border-gray-800 relative">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-xl font-bold text-gray-900 dark:text-white">Importar Emails</h3>
                  <p className="text-sm text-gray-500">
                    Novos emails serão adicionados. Existentes serão atualizados.
                  </p>
                </div>
              </div>
              <button
            ...
            <div className="p-6">
              <div
                className={`
                  ...
                  ${dragActive 
                    ? 'border-emerald-500 bg-emerald-50/80 dark:bg-emerald-950/50 shadow-lg scale-105' 
                    : 'border-dashed border-emerald-300 hover:border-emerald-400 bg-gradient-to-b from-emerald-50/50 to-teal-50/50 dark:from-emerald-950/30 dark:to-teal-950/30'
                  }
                `}
              ...
              >
                <FileText className="w-14 h-14 text-emerald-500 mb-4 opacity-80" />
              ...
              {/* Preview */}
              {file && (
                <div className="mt-6 p-4 bg-emerald-50 dark:bg-emerald-950/50 border border-emerald-200 dark:border-emerald-800 rounded-xl">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3 flex-1">
                      ...
                      <div className="min-w-0">
                        <p className="font-semibold text-emerald-900 dark:text-emerald-100 truncate">{file.name}</p>
                        <p className="text-sm text-emerald-700 dark:text-emerald-300">{(file.size / 1024).toFixed(1)} KB</p>
                      </div>
                    </div>
                    <Button
                      variant="ghost"
            ...
            <div className="p-6 pt-0 border-t border-gray-200 dark:border-gray-800 bg-gradient-to-t from-white/70 to-transparent dark:from-gray-900/70">
              <div className="flex gap-3 justify-end pt-4">
                ...
                <Button
                  ...
                  className="px-8 bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white shadow-lg hover:shadow-xl disabled:opacity-50 min-h-[44px]"
                >
                  {isUploading ? (
                    <>
