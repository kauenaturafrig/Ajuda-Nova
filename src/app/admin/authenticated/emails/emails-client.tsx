...
import { ArrowLeft, Download, Plus, Search, Trash2, Edit2, XCircle, Mail, SlidersHorizontal } from "lucide-react";
          ...
          <section className="bg-white dark:bg-neutral-900/40 rounded-2xl border border-gray-100 dark:border-neutral-800/80 p-6 shadow-sm" ref={formRef}>
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  <h2 className="text-base font-bold text-gray-900 dark:text-white">
                    {editingId ? "Editar Email Selecionado" : "Adicionar Novo Email"}
                  </h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-4 items-start">
              <div className="lg:col-span-3">
                ...
                />
                {formErrors.email && (
                  <p className="text-red-500 font-medium text-[11px] mt-1 ml-1">{formErrors.email}</p>
                )}
              </div>
              ...
              <div className="lg:col-span-3">
                <Input
                  ...
                  onChange={(e) => setFormEmail((prev) => ({ ...prev, nome: e.target.value }))}
                  className={`rounded-xl h-10 border-gray-200 dark:border-neutral-800 text-xs ${
              ...
              <div className="lg:col-span-2">
                <Input
                  ...
                  onChange={(e) => setFormEmail((prev) => ({ ...prev, setor: e.target.value }))}
                  className={`rounded-xl h-10 border-gray-200 dark:border-neutral-800 text-xs ${
              ...
              <tbody className="divide-y divide-gray-100 dark:divide-neutral-800/60 text-gray-900 dark:text-gray-100">
                {filteredEmails.length === 0 ? (
                  ...
                  filteredEmails.map((email) => (
                    <tr key={email.id} className="hover:bg-gray-50/50 dark:hover:bg-neutral-900/40 transition-colors">
