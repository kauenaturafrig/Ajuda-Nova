      ...
      <div className="container mx-auto p-6 max-w-4xl bg-white shadow-lg rounded-lg my-8">
        ...
        <section className="mb-8">
          ...
          <p className="text-lg text-gray-700 leading-relaxed">
            Se você precisa "dar um reset", restaurar de fábrica, escaneie esse
            código
          </p>
        ...
        <section className="mb-8">
          ...
          <p className="text-lg text-gray-700 leading-relaxed">
            Se você precisa colocar na "Leitura Contínua" (Quando não quiser
            ficar bipando na mão),escaneie esse código
          </p>
          <div className="flex justify-center">
            <Image
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-gray-800 mb-3">
            Desligar LED Leitura Contínua
          </h2>
          <p className="text-lg text-gray-700 leading-relaxed">
            Se você precisa desligar o LED da Leitura Contínua, escaneie esse
            código
          </p>
          <div className="flex justify-center">
            <Image
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-gray-800 mb-3">
            Converter UPC para EAN-13
          </h2>
          <p className="text-lg text-gray-700 leading-relaxed">
            Se você precisa converter para o formato de leitura EAN-13, escaneie
            esse código
          </p>
          <div className="flex justify-center">
            <Image
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-gray-800 mb-3">
            Converter padrão USA (EUA) para BR
          </h2>
          <p className="text-lg text-gray-700 leading-relaxed">
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-bold text-gray-800 mb-3">
            Entrada USB HID de código no Tablet
          </h2>
          <p className="text-lg text-gray-700 leading-relaxed">
            Se você precisa habilitar a entrada USB HID de código no Tablet,
            escaneie esse código
          </p>
          <div className="flex justify-center">
            <Image
